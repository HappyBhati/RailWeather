...
$x=$_REQUEST['cid'];
?>
<script> window.location="pnr.php?cid=<?php echo $x; ?>" </script>
<?php } ?>
<html>
<head>
<title>Home</title>
...
<form>
    ...
    <input type="text" placeholder="            Enter PNR " name="cid" style="border-color:#FFF;                                                   background-color:transparent;
font-size:20px;
